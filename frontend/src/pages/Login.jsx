      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center space-y-1">
          <p className="text-xs text-slate-400">
            Are you a doctor?{' '}
            <Link to="/doctor/login" className="text-primary hover:underline">Doctor portal</Link>
          </p>
          <p className="text-xs text-slate-400">
            Admin?{' '}
            <Link to="/admin/login" className="text-primary hover:underline">Admin panel</Link>
          </p>
        </div>
      </div>
    </div>
